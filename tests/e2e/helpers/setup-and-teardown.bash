...
SERVER_PID_FILE=$REPO_ROOT/tests/e2e/.galoy_server_pid
WS_SERVER_PID_FILE=$REPO_ROOT/tests/e2e/.galoy_ws_server_pid
TRIGGER_PID_FILE=$REPO_ROOT/tests/e2e/.galoy_trigger_pid
EXPORTER_PID_FILE=$REPO_ROOT/tests/e2e/.galoy_exporter_pid
SUBSCRIBER_PID_FILE=$REPO_ROOT/tests/e2e/.gql_subscriber_pid
